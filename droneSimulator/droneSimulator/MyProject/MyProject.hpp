...
struct Model {
	...
	void loadModel(std::string file, int val);
	void createIndexBuffer();
	void createVertexBuffer();

	void init(BaseProject *bp, std::string file, int val);
	void cleanup();
};
...
void Model::loadModel(std::string file, int val) {
...
void Model::init(BaseProject *bp, std::string file, int val) {
	BP = bp;
	loadModel(file, val);
	createVertexBuffer();
	createIndexBuffer();
